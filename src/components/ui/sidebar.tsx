...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        'relative flex min-h-svh flex-1 flex-col dark:bg-background bg-zinc-100 overflow-x-auto ',
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'hover:bg-secondary data-[active=true]:bg-secondary data-[active=true]:font-semibold',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
